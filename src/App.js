    ...
    <s.Screen>
      ...
      >
        ...
        <ResponsiveWrapper flex={1} style={{ padding: 24 }} test>
          ...
          >
            <s.TextTitle
                  style={{ textAlign: "center",fontSize: 60, color: "var(--accent-text)", marginBottom: 30 }}
                >{CONFIG.NFT_NAME}
                </s.TextTitle>

                <s.Container flex={1} jc={"center"} ai={"center"}>
            <StyledImg   style={{ border: "4px solid var(--primary)" }} alt={"example"} src={"/config/images/preview.gif"} />
          </s.Container>
